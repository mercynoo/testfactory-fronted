...
export default {
    bootstrap() {
        ...
        //读取用户列表信息
        mock.onGet('/trade/list').reply(config => {
            console.log(config)
        ...
        //读取用户分页信息
        mock.onGet('/trade/pageList').reply(config => {
        ...
        //删除用户信息
        mock.onGet('/trade/remove').reply(config => {
            console.log(config)
        ...
        //新增用户信息
        mock.onGet('/trade/add').reply(config => {
            ...
            //编辑用户信息
        mock.onGet('/trade/edit').reply(config => {
            ...
            //批量删除用户信息
        mock.onGet('/trade/batchRemove').reply(config => {
